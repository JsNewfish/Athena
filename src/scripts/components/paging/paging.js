...
angular.module("dp.ui.paging", [])
    .directive('paging', function () {
        ...
        function setScopeValues(scope, attrs) {
            ...
            scope.adjacent = parseInt(scope.adjacent)==0? 0: 1;
            ...
            scope.pageSizeEnum = scope.pageSizeEnum.map(function(data){  
                return +data;  
            });
        }
        ...
        function build(scope, attrs) {
            ...
            var fullAdjacentSize = scope.adjacent==0 ? 1:(scope.adjacent * 2) + 2;
